...
import { useContasAPagar } from '@/hooks/useSupabaseData'
import { ContaAPagar, supabase } from '@/lib/supabase'
import { useContasBancarias } from '@/hooks/useSupabaseData'
...
export function ContasAPagarUnificado() {
  ...
  // Teste de conectividade - temporário para debug
  useEffect(() => {
